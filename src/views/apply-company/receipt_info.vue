  ...
  <div>
    ...
    <ul>
      <li>
        ...
        <group>
          <cell title="银行" :value="bankName" :link="{path:'/company-bank-list'}"></cell>
        </group>
        <group>
...
<script>
  import {submitReceiptPermit, submitReceiptUpdate, submitReceipt} from '../../service/apply-company.js'
export default {
  components: {
