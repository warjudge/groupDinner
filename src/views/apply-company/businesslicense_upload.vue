  ...
  <div>
    ...
    <ul>
      ...
      <li style="padding-top: 0;">
        <group>
            <x-input title="企业名称" v-model="name" placeholder="请填写营业执照上的名称"></x-input>
          </group>
          <group>
            <x-input title="联系人名称" v-model="ownerName" placeholder="请填写在平台展示的名称"></x-input>
          </group>
      </li>
    </ul>
...
<script>
  import {submitBuslicense, submitBuslicenseUpdate} from '../../service/apply-company.js'
export default {
  data () {
    return {
      titleText:'',
