...
export default {
  ...
  methods:{
    ...
    submit(){
      if(this.isReapply){
        this.$router.push({path:'/company-license-upload',query:{reapply:true}});
      }else if(this.isRefill){
        this.$router.push({path:'/company-license-upload',query:{refill:true}});
      }else{
        this.$router.push({path:'/company-license-upload'});
      }
    },
  },
}
